---
title: "TSP Pre Analysis Baseline"
author: "JR"
date: "06.06.2023"
...
long_d <- long_d %>% dplyr::select(id,gruppe,condition,t04_r0,t04_r1,t04_r2,t04_r3,t04_r4,t04_r5,t04_r6,t04_r7,t04_r8,t04_r9) %>% filter(condition == "Baseline") %>%
                    droplevels()
...
aov_oa$condition <- car::recode(aov_oa$condition, "'Baseline' = 'Pre'")  
  
  
aov_bind <- dplyr::bind_rows(aov_tsp,aov_oa) %>% dplyr::select(id,gruppe,condition,tsp)
aov_tsp <- aov_bind 
aov_tsp$condition <- car::recode(aov_tsp$condition, "'Baseline' = 'Post'")  
```
...
# Four extreme outlieres 
# One extreme outlier regarding differences
# Differences not normal distributed in the HC group
# Only TSP post normal distributed
```
...
```{r}
aov_tsp_od <- aov_tsp %>% dplyr::filter(id != "VR_009" & id != "VR_023" & id != "VR_048" & id != "VR_056" & id != "VR_013")
