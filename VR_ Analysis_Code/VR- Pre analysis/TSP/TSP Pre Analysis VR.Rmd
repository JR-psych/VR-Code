...
long_d <- long_d %>% dplyr::select(id,gruppe,condition,t04_r0,t04_r1,t04_r2,t04_r3,t04_r4,t04_r5,t04_r6,t04_r7,t04_r8,t04_r9) %>% filter(condition == "VR") %>%
                    droplevels()
...
aov_oa$condition <- car::recode(aov_oa$condition, "'VR' = 'Pre'")  
  
  
aov_bind <- dplyr::bind_rows(aov_tsp,aov_oa) %>% dplyr::select(id,gruppe,condition,tsp)
aov_tsp <- aov_bind 
aov_tsp$condition <- car::recode(aov_tsp$condition, "'VR' = 'Post'")  
```
...
# One extreme outlier (id09) and one regarding differences
# Differences not normal distributed
# Only CP-Post normal distributed
...
```{r}
aov_tsp_od <- aov_tsp %>% dplyr::filter(id != "VR_009" & id != "VR_013")
